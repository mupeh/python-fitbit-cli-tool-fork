...
class Fitbit(object):
    ...
    def activity_daily_summary(self, user_id=None, base_date=None):
        """
        * https://dev.fitbit.com/docs/activity/#get-activity-daily-summary
        Parameters
        ----------
        base_date : str
        ...
        url = "{0}/{1}/user/{2}/activities/date/{3}.json".format(
            *self._get_common_args(user_id),
            self._get_date_string(base_date)
        )
        return self.make_request(url)
